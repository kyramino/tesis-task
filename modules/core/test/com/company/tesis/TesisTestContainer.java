...
public class TesisTestContainer extends TestContainer {

    public TesisTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/tesis/app.properties",
    ...
    public static class Common extends TesisTestContainer {

        public static final TesisTestContainer.Common INSTANCE = new TesisTestContainer.Common();
